...
const NAV = [
  ...
  { label: "Projects", href: "/admin/projects", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
    ...
    <div className="flex min-h-screen bg-gray-950 text-gray-100">
      ...
      <aside className="w-60 shrink-0 border-r border-gray-800 flex flex-col">
        <div className="px-6 py-5 border-b border-gray-800">
          <p className="text-xs text-indigo-400 font-semibold uppercase tracking-widest">Admin</p>
          <p className="text-sm font-bold text-white mt-0.5">Portfolio CMS</p>
        </div>
        ...
        <div className="px-3 py-4 border-t border-gray-800 flex flex-col gap-2">
          ...
          <button
            onClick={logout}
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-400 hover:text-red-400 hover:bg-gray-800 transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
